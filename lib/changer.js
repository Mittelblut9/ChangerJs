...
class Randomint {
    #defaultLength = 10;
    constructor(length = this.#defaultLength) {
        this.length = length;
...
export function getCJChanges(el) {
    ...
    if (element.dataset.cjclick == 'true') {
        ...
        return new Error({message: 'You have to declare the element with the data-cjclick="true" attribute to call the function', type: 'NoDatasetassed', code: '004'});
    }
}